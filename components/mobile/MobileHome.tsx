      ...
      style={
        {
          ...
          overflowY: "auto",
          overflowX: "hidden",
          // Proximity so the user can scroll through the Name section
          // — which holds Name + Intro + Engagements + CV and grows
          // past 100dvh on shorter phones — without being yanked back
          // to the top. Snap engages when releasing near a section
          // boundary (Hello, Work, Contact).
